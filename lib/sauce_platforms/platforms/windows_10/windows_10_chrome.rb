module Platform
  module Windows_10_chrome
    class << self
      ...
      def v51
        windows_10_chrome '51'
      end

      def v52
        windows_10_chrome '52'
      end

      def v53
        windows_10_chrome '53'
      end

      def v54
        windows_10_chrome '54'
      end

      def v55
        windows_10_chrome '55'
      end

      def v56
        windows_10_chrome '56'
      end

      def v57
        windows_10_chrome '57'
      end

      def v58
        windows_10_chrome '58'
      end
